...
\begin{figure}[htb]
\hspace*{-1.2cm}
\psfig{file=\EPSDIR/realcas.filiere_amont.eps,width=15.cm}
\vspace*{-0.4cm}
...
\begin{figure}[htb]
\hspace*{-1.2cm}
\psfig{file=\EPSDIR/realcas.filiere_amont_spawning.eps,width=15.cm}
\vspace*{-0.4cm}
\caption{schematic view of the interactions between the different files
...
\begin{figure}[h]
\hspace*{2.5cm}
\psfig{figure=\EPSDIR/realcas.3Dhorinterp.eps,width=10.cm}
...
\begin{figure}[htb]
\hspace*{-1.7cm}
\psfig{figure=\EPSDIR/realcas.6grids.eps,width=18.cm}
...
\begin{figure}[htb]
\hspace*{-0.5cm}
\psfig{figure=\EPSDIR/realcas.grid.eps,width=19.cm}
...
\begin{figure}[htb]
\hspace*{-0.5cm}
\psfig{figure=\EPSDIR/realcas.physhift.eps,width=16.cm}
