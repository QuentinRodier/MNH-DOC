...
\begin{figure}
\subfigure[\large Distribution]{\includegraphics[width=0.45\textwidth]{EPS/MU_dx_fit_REVIEW-eps-converted-to.pdf}}
\subfigure[\large Dispersion]{\includegraphics[width=0.45\textwidth]{EPS/dispersion_Mu_REVIEW-eps-converted-to.pdf}}
