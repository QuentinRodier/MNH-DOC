...
\begin{figure}
%\psfig{figure=nest-ex.eps}
\psfig{figure=\EPSDIR/nest-ex.eps}
...
\begin{figure}[pbh]
%\psfig{figure=Bikhardt.eps,width=8.cm}
\psfig{figure=\EPSDIR/Bikhardt.eps,width=8.cm}
\vspace{1cm}
...
We finaly prefered a "sequential" approach, consisting in running at the same time
...
\begin{figure}[pbh]
%\psfig{figure=horzgrid2.eps,width=13.5cm}
\psfig{figure=\EPSDIR/horzgrid2.eps,width=13.5cm}
\vspace{1cm}
