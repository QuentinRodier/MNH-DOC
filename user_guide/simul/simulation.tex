...
\hline \hline
\endhead
SEDI   & sedimentation                                  & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_S>=1) \\\hline
CNVI   & conversion of snow to cloud ice                & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_S>=1) \\\hline
CNVS   & conversion of pristine ice to snow             & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_S>=1) \\\hline
BRKU   & break up of snow                               & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
RIM    & heavy riming of cloud droplet on snow          & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
ACC    & accretion of rain on snow                      & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
CMEL   & conversion melting of snow                     & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
WETG   & wet growth of graupel                          & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
DRYG   & dry growth of graupel                          & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
WETH   & wet growth of hail                             & LPTSPLIT=T or NMOM\_H>=1 \\\hline
SSC    & snow self collection                           & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_S>=1) \\\hline
...
ACC    & accretion of rain on snow                      & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
CMEL   & conversion melting of snow                     & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
CFRZ   & conversion freezing of raindrop                & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
WETG   & wet growth of graupel                          & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
GMLT   & raupel melting                                 & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_C>=1 and NMOM\_S>=1) \\\hline
WETH   & wet growth of hail                             & LPTSPLIT=T or NMOM\_H>=1 \\\hline
COHG   & conversion hail graupel                        & LPTSPLIT=T or NMOM\_H>=1 \\\hline
CEDS   & adjustment to saturation                       & LPTSPLIT=F and NMOM\_I>=1 and LSPRO=F \\\hline
\end{longtable}
...
\hline \hline
\endhead
SEDI   & sedimentation                                  & LPTSPLIT=T or (NMOM\_I>=1 and NMOM\_S>=1 and NMOM\_H>=1) \\\hline
WETG   & wet growth of graupel                          & LPTSPLIT=T or NMOM\_H>=1 \\\hline
COHG   & conversion hail graupel                        & LPTSPLIT=T or NMOM\_H>=1 \\\hline
HMLT   & hail melting                                   & LPTSPLIT=T or NMOM\_H>=1 \\\hline
\end{longtable}
