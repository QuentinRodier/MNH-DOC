...
\item 'DEFAULT' for use the same parameters as in Phillips et al. 2008 or 2023
\end{itemize}
\item
...
LSPRO : flag to use a saturation adjustment for cloud droplets (if set to T) or the "diagnostic supersaturation" from Thouron et al. 2012 (if set to F and LSPRO=F).
\end{itemize}
