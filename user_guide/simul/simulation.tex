...
CCCN\_MODES : Select the size distribution of CCN modes \\ ('JUNGFRAU','COPT','MACC','MACC\_JPP','SIRTA','CPS00','FREETROP')
\item
...
HTYPE\_CCN : Switch to affect maritime or continental activation properties to each CCN mode : 'C' continental or 'M' maritime. NH42SO4 (=C), NH4NO3, NaCl (=S), H2SO4, NaNO3, NaHSO4, Na2SO4, NH43HSO42, SOA
\item
...
%
This namelist is used to configure a virtual observed point at a station by using the following described parameters \bf{or} a .csv file. Calculations are done for all the nested models and recorded in the corresponding diachronic files.\\
