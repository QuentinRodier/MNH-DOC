...
(if CCLOUD='ICEx' and LRED=T) &saturation &   &  \\\hline
...
(if CCLOUD='LIMA' and LPTSPLIT=T) & after sedimentation &   &  \\\hline
...
(if CCLOUD='ICEx' or 'LIMA') & of rain drops &   &  \\\hline
...
(if CCLOUD='ICEx'and LRED=T) &  on ice&   &  \\\hline
...
(if CCLOUD='LIMA' and LHHONI=T) &  nucleation &   &  \\\hline
...
NDEPGRG  & deposition on graupel & integer  &  0 \index{NDEPGRG!\innam{NAM\_BU\_RRG}}\\\hline
NRIMRG   & riming of cloud water & integer  &  0 \index{NRIMRG!\innam{NAM\_BU\_RRG}}\\\hline
NCMELRG  & conversion melting of snow & integer  &  0 \index{NCMELRG!\innam{NAM\_BU\_RRG}}\\\hline
NCFRZRG  & conversion freezing of rain& integer  &  0 \index{NCFRZRG!\innam{NAM\_BU\_RRG}}\\\hline
...
(if CCLOUD='ICE4' and LRED=T) & ConVersion  &   &  \\\hline
NACCRG  & rain accretion on graupel & integer  &  0 \index{NACCRG!\innam{NAM\_BU\_RRG}}\\\hline
...
(if CCLOUD='LIMA' and LHAIL=T) &  &   &  \\\hline
NDRYHRH  &  dry growth of hail & integer  &  0 \index{NDRYHRH!\innam{NAM\_BU\_RRH}}\\\hline
NCORRRH  &  correction & integer  &  0 \index{NCORRRH!\innam{NAM\_BU\_RRH}}\\\hline
NHGCVRH  &  Hail to Graupel ConVersion & integer  &  0 \index{NHGCVRH!\innam{NAM\_BU\_RRH}}\\\hline
NGHCVRH  &  Graupel to Hail ConVersion & integer  &  0 \index{NGHCVRH!\innam{NAM\_BU\_RRH}}\\\hline
NCOHGRH  & reconversion from hail  & integer  &  0 \index{NCOHGRH!\innam{NAM\_BU\_RRG}}\\
(if CCLOUD='LIMA' and LHAIL=T) &to graupel  &   &  \\\hline
\end{tabular}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{tabular} {|p{8cm}|p{4cm}|>{\centering}p{1.5cm}|p{1.5cm}<{\centering}|}
\hline
NACCRRR  & accretion of cloud droplets & integer  &  0 \index{NACCRRR!\innam{NAM\_BU\_RRR}}\\\hline
NAUTORR   & autoconversion into rain drops& integer  &  0 \index{NAUTORR!\innam{NAM\_BU\_RRR}}\\\hline
NREVARR   & rain evaporation  & integer  &  0 \index{NREVARR!\innam{NAM\_BU\_RRR}}\\\hline
NSEDIRR   & sedimentation of rain drops& integer  &  0 \index{NSEDIRR!\innam{NAM\_BU\_RRR}}\\\hline
...
(if CCLOUD='ICEx' or 'LIMA') & on aggregates&   &  \\\hline
...
(if CCLOUD='LIMA' and LPTSPLIT=T) & sedimentation&   &  \\\hline
...
(if CCLOUD$ \neq$ 'NONE' or 'ICEx') & cloud water evaporation& &   \\\hline
...
(if CCLOUD='ICE3', 'ICE4' or 'LIMA') & &   &  \\\hline
...
(if CCLOUD='ICE3' or 'ICE4' and LRED) & &   &  \\\hline
NADJURV  & adjustment before          & integer  &  0 \index{NADJURV!\innam{NAM\_BU\_RRV}}\\
(if CCLOUD='ICE3' or 'ICE4' and LRED) & &   &  \\\hline
NHINDRV   & Heterogeneous Nucle-& integer  &  0 \index{NHINDRV!\innam{NAM\_BU\_RRV}}\\
(if CCLOUD='LIMA'  ) &ation by Deposition  &   &  \\\hline
...
(if CCLOUD='C2R2' or 'KHKO'  ) & induced by turbulence&   &  \\\hline
...
(if CTURB='TKEL') &diffusion &   &  \\\hline
NCHEMSV & chemistry activity & integer  &  0 \index{NCHEMSV!\innam{NAM\_BU\_RSV}} \\\hline
NDEPOTRSV  & droplet deposition over    & integer  &  0 \index{NDEPOTRSV!\innam{NAM\_BU\_RRC}}\\
(if (CCLOUD='C2R2' or 'KHKO') and (LDRAGTREE and LDEPOTREE)  ) & tree &   &   \\\hline
\end{tabular}
\end{center}

\textbf{Concentration of activated nuclei}
\begin{center}
\begin{tabular} {|p{8cm}|p{4cm}|>{\centering}p{1.5cm}|p{1.5cm}<{\centering}|} 
\hline
Fortran name & Meaning & Fortran type & default value \\
...
if (CCLOUD='LIMA') and (LPTSPLIT=T &&& \\
or (LCOLD=T, LWARM=T and LSNOW=T))&&& \\
\hline
\end{tabular}
\end{center}
\begin{center}
...
LHHONI=T and NMOD\_CCN > 1 &&& \\

\hline
\end{tabular}
\end{center}

\textbf{Concentration of pristine ice crystals}
\begin{center}
\begin{tabular} {|p{8cm}|p{4cm}|>{\centering}p{1.5cm}|p{1.5cm}<{\centering}|} 
\hline
Fortran name & Meaning & Fortran type & default value \\
...
\begin{center}
\begin{tabular} {|p{7cm}|p{5cm}|>{\centering}p{1.5cm}|p{1.5cm}<{\centering}|} 
\hline
Fortran name & Meaning & Fortran type & default value \\
\hline\hline
NNEGASV & negativity correction& integer & 0 \\
...
\textbf{Volumetric charge of cloud droplets}
\begin{center}
\begin{tabular} {|p{8cm}|p{4cm}|>{\centering}p{1.5cm}|p{1.5cm}<{\centering}|} 
\hline
Fortran name & Meaning & Fortran type & default value \\
...
\textbf{Volumetric charge of rain drops}
\begin{center}
\begin{tabular} {|p{7cm}|p{5cm}|>{\centering}p{1.5cm}|p{1.5cm}<{\centering}|} 
\hline
Fortran name & Meaning & Fortran type & default value \\
...
\textbf{Volumetric charge of ice crystals}
\begin{center}
\begin{tabular} {|p{6cm}|p{6cm}|>{\centering}p{1.5cm}|p{1.5cm}<{\centering}|} 
\hline
Fortran name & Meaning & Fortran type & default value \\
\hline\hline
...
\textbf{Volumetric charge of snow}
\begin{center}
\begin{tabular} {|p{6cm}|p{6cm}|>{\centering}p{1.5cm}|p{1.5cm}<{\centering}|} 
\hline
Fortran name & Meaning & Fortran type & default value \\
...
\textbf{Volumetric charge of graupel}
\begin{center}
\begin{tabular} {|p{8cm}|p{4cm}|>{\centering}p{1.5cm}|p{1.5cm}<{\centering}|} 
\hline
Fortran name & Meaning & Fortran type & default value \\
...
NINDSV & induction & integer & 0 \\
if CCLOUD='ICEx' and LINDUCTIVE=T &&& \\
...
(if CCLOUD='ICE3','ICE4','KHKO','C2R2', or &nucleation &   &  \\
'LIMA') & &   &  \\\hline
...
(if CCLOUD='ICE3' or 'ICE4' or 'LIMA') & &   &  \\\hline
...
(if CCLOUD='ICE3' or 'ICE4' or 'LIMA') & of rain &   &  \\\hline
...
(if CCLOUD='KHKO' or 'C2R2')   &induced by turbulence   &       &   \\\hline
