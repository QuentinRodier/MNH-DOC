...
\item XTSTEP: data storage frequency. If not set, it is forced to 60s. The frequency must be a multiple of the timestep of the chosen model NMODEL if CMODEL='FIX' or of the main model 1 if CMODEL='MOB'. It will be enforced at run.
...
\textbf{Warning:} if the altitude is given in pressure, the units are hPa and not Pa.
...
\item XTSTEP: data storage frequency. If not set, it is forced to 60s. The frequency must be a multiple of the timestep of the chosen model NMODEL if CMODEL='FIX' or of the main model 1 if CMODEL='MOB'. It will be enforced at run. Balloon positions are not computed with this timestep but with the model one.
...
CMEL   & collection by snow and conversion into rain with $T>XTT$ on ice & LRED=T and CELEC/='ELE3' \\\hline
DRYH   & dry growth of hail                            & CCLOUD='ICE4' and LRED=T and CELEC='NONE' \\\hline
ADJU   & adjustement to saturation                     & LRED=T and LADJ\_BEFORE=T and CELEC/='ELE3' \\\hline
WETH   & wet growth of hail                            & CCLOUD='ICE4' \\\hline
CORR   & correction                                    & LRED=T and CELEC/='ELE3' \\\hline
NEGA   & negativity correction                         & no condition \\\hline
NETUR  & negativity correction induced by turbulence   & CTURB='TKEL' \\\hline
NEADV  & negativity correction induced by advection    & no condition \\\hline
NECON  & negativity correction induced by condensation & no condition \\\hline
...
DEPI   & condensation/deposition on ice                & LRED=F or ( LRED=T and LADJ\_AFTER=T) or CELEC/='NONE' \\\hline
CORR   & correction                                    & LRED=T and CELEC/='ELE3' \\\hline
ADJU   & adjustment to saturation                      & LRED=T and LADJ\_BEFORE=T and CELEC/='ELE3' \\\hline
NEGA   & negativity correction                         & no condition \\\hline
NETUR  & negativity correction induced by turbulence   & CTURB='TKEL' \\\hline
NEADV  & negativity correction induced by advection    & no condition \\\hline
NECON  & negativity correction induced by condensation & no condition \\\hline
...
CMEL   & collection of droplets by snow and conversion into rain & LRED=T and CELEC/='ELE3' \\\hline
CFRZ   & conversion freezing of rain                             & no condition \\\hline
WETG   & wet growth of graupel                                   & no condition \\\hline
DRYG   & dry growth of graupel                                   & no condition \\\hline
GMLT   & graupel melting                                         & no condition \\\hline
...
DCONV  & KAFR convection                & CDCONV='KAFR' or CSCONV='KAFR'   \\\hline
DRAGB  & vapor released by buildings    & LDRAGBLDG=T                      \\\hline
...
\subsubsection{Electricity source terms}
...
ADJU   & adjustement to saturation      & CCLOUD(1:3)='ICE' and LRED=T and LADJ\_BEFORE \\\hline
DEPS   & deposition on snow             & no condition \\\hline
DEPG   & deposition on graupel          & no condition \\\hline
REVA   & rain evaporation               & NMOM\_C>=1   \\\hline
DEPI   & condensation/deposition on ice & CCLOUD(1:3)='ICE' and (LRED=F or LADJ\_AFTER) \\\hline
CEDS   & adjustement to saturation      & CCLOUD='LIMA' \\\hline
NEUT   & neutralization                 & no condition \\\hline
SUBI   & sublimation of ice crystals    & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
CORR2  & supplementary correction inside LIMA splitting & CCLOUD='LIMA' and LPTSPLIT=T  \\\hline
\end{longtable}
...
CEDS   & adjustement to saturation      & CCLOUD='LIMA' \\\hline
NEUT   & neutralization                 & no condition \\\hline
R2C1   & rain to cloud change after sedimentation & CCLOUD='LIMA' and LPTSPLIT=T and NMOM\_C>=1 NMOM\_R>=1 \\\hline
CORR2  & supplementary correction inside LIMA splitting & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
CMEL   & collection by snow and conversion into rain with T>XTT on ice & CCLOUD(1:3)='ICE' and LRED=T \\\hline
\end{longtable}
...
CORR2  & supplementary correction inside LIMA splitting & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
CMEL   & collection by snow and conversion into rain with T>XTT on ice & CCLOUD(1:3)='ICE' and LRED=T \\\hline
RDSF   & raindrop shattering by freezing & CCLOUD='LIMA' and LPTSPLIT=T and LRDSF=T \\\hline
\end{longtable}
...
NIIG   & non-inductive charge separation due to ice-graupel collisions & no condition \\\hline
SEDI   & sedimentation                  & no condition \\\hline
DEPI   & condensation/deposition on ice & CCLOUD(1:3)='ICE' and (LRED=F or LADJ\_AFTER) \\\hline
CEDS   & adjustement to saturation      & CCLOUD='LIMA' \\\hline
NEUT   & neutralization                 & no condition \\\hline
CNVI   & conversion of snow to cloud ice & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
SUBI   & sublimation of ice crystals    & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
HMS    & Hallett-Mossop ice multiplication process due to snow riming & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
HMG    & Hallett-Mossop ice multiplication process due to graupel riming & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
CIBU   & collisional ice breakup         & CCLOUD='LIMA' and LPTSPLIT=T and LCIBU=T \\\hline
RDSF   & raindrop shattering by freezing & CCLOUD='LIMA' and LPTSPLIT=T and LRDSF=T \\\hline
CORR2  & supplementary correction inside LIMA splitting & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
\end{longtable}
...
DRYG   & dry growth of graupel     & no condition \\\hline
NIIS   & non-inductive charge separation due to ice-snow collisions & no condition \\\hline
NISG   & non-inductive charge separation due to snow-graupel collisions & no condition \\\hline
WETH   & wet growth of hail        & CCLOUD='ICE4' \\\hline
SEDI   & sedimentation             & no condition \\\hline
CNVI   & conversion of snow to cloud ice & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
HMS    & Hallett-Mossop ice multiplication process due to snow riming & CCLOUD='LIMA' and LPTSPLIT=T \\\hline
...
\paragraph{Volumetric charge of hail (ICE4 or LIMA with NMOM\_H>=1 only)}
\mbox{} %necessary to ensure longtable is after paragraph text
...
DCONV  & KAFR convection                & CDCONV='KAFR' or CSCONV='KAFR'          \\\hline
BLAZE  & Blaze fire model               & LBLAZE=T                                \\\hline
DRAGB  & heat released by buildings     & LDRAGBLDG=T                             \\\hline
HTURB  & horizontal turbulent diffusion & CTURB='TKEL' and CTURBDIM='3DIM'        \\\hline
VTURB  & vertical turbulent diffusion   & CTURB='TKEL'                            \\\hline
...
\index{LIO\_ALLOW\_NO\_BACKUP!\innam{NAM\_CONFIO}}

\item
LIO\_NO\_WRITE : disable file writes (useful for benchs)
\index{LIO\_NO\_WRITE!\innam{NAM\_CONFIO}}

\item
NFILE\_NUM\_MAX: maximum number for numbered files (mainly backup and output files). If less than 1000, the numbers will be on 3 digits. From 1000, they will be on the number of digits of NFILE\_NUM\_MAX (5 if NFILE\_NUM\_MAX=12345).
\index{NFILE\_NUM\_MAX!\innam{NAM\_CONFIO}}
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Namelist NAM\_DRAGBLDGn}
\label{s:namdragbldg}
\index{NAM\_DRAGBLDGn!namelist description}
%
...
%
\begin{itemize}
\index{LDRAGBLDG!\innam{NAM\_DRAGBLDGn}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Namelist NAM\_COUPLING\_LEVELSn}
\label{s:namcouplinglevels}
\index{NAM\_COUPLING\_LEVELSn!namelist description}
%
...
%
\begin{itemize}
\index{NLEV\_COUPLE!\innam{NAM\_COUPLING\_LEVELSn}}
...
\begin{itemize}
\item `ADNR' to use the  Non-Rotating Actuator Disc method.
\item `ADR' to use the  Rotating Actuator Disc method.
...
\end{itemize}
\subsection{Namelist NAM\_EOL\_ADR}
\index{NAM\_EOL\_ADR!namelist description}
...
CINTERP             & 3 characters     & `CLS' \\
NNB\_AZIELT         & integer          & 56 \\
NNB\_RADELT         & integer          & 18 \\
...
\end{tabular}
\end{center}
\index{CFARM\_CSVDATA!\innam{NAM\_EOL\_ADR}}
...
\end{tabular}
\end{center}
\index{CTURBINE\_CSVDATA!\innam{NAM\_EOL\_ADR}}
...
\end{tabular}
\end{center}
\index{CBLADE\_CSVDATA!\innam{NAM\_EOL\_ADR}}
...
\end{tabular}
\end{center}
\index{CAIRFOIL\_CSVDATA!\innam{NAM\_EOL\_ADR}}
...
\end{itemize}
\index{CMETH\_EOL!\innam{NAM\_EOL\_ADR}}

\item NNB\_AZIELT: number of elements for the azimutal discretisation of the disc. To determine the value to be specified, refer to the scientific documentation.
\index{NNB\_RADELT!\innam{NAM\_EOL\_ADR}}

\item NNB\_RADELT: number of elements for the radial discretisation of the disc. This value is independent of the number of elements in CBLADE\_CSVDATA, as the algorithm will proceed to its own discretization through an interpolation of the data given by the blade description (CBLADE\_CSVDATA). To determine the value to be specified, refer to the scientific documentation.
\index{NNB\_RADELT!\innam{NAM\_EOL\_ADR}}
...
\begin{itemize}
\item .TRUE.  activates the tip loss correction of Glauert.
\item .FALSE. no activation.
\end{itemize}
\index{LTIPLOSSG!\innam{NAM\_EOL\_ADR}}

\item LTECOUTPTS: flag to enable the output of geometrical points (XYZ) for wind turbines in a Tecplot file. This provides spatial positions at each element point of the wind turbine, facilitating setup checks such as geometry and wind farm layout.
\begin{itemize}
\item .TRUE.  activates Tecplot output.
\item .FALSE. deactivates it.
\end{itemize}
\index{LTECOUTPTS!\innam{NAM\_EOL\_ADR}}

\item LCSVOUTFRM: flag to enable the output of frames $\left(\overrightarrow{e_x},\overrightarrow{e_y},\overrightarrow{e_z}\right)$ for wind turbines in a CSV file. This describes the spatial positions and orientations of frames for each kinematic part of the wind turbine. Useful for verifying setup details, including positions and orientations of its components.
\begin{itemize}
\item .TRUE.  activates the CSV output.
\item .FALSE. deactivates it.
\end{itemize}
\index{LCSVOUTFRM!\innam{NAM\_EOL\_ADR}}
...
\item NNB\_BLAELT: number of blade elements for the discretisation of the blade radius. This value is independent of the number of elements in CBLADE\_CSVDATA, as the algorithm will proceed to its own discretization through an interpolation of the data given by the blade description (CBLADE\_CSVDATA). To determine the value to be specified, refer to the scientific documentation. 
...
\begin{itemize}
\item .TRUE.  activates time-splitting method only if XTSTEP (NAM\_DYNn) is too high.
\item .FALSE. desactivates it.
\end{itemize}
\index{LTIMESPLIT!\innam{NAM\_EOL\_ALM}}

\item LTIPLOSSG: flag to enable the tip loss correction of Glauert. 
Usually applied to alleviate the over-predicted loads at the blade tip region when the low resolution or the smearing method cannot capture tip vortices. One can note that this correction should only be used with models such as the Actuator Disc with Rotation to correct for finite number of blades.
\begin{itemize}
\item .TRUE.  activates the tip loss correction of Glauert.
\item .FALSE. desactivates it.
...
\item .FALSE. deactivates it.
\end{itemize}
\index{LCSVOUTFRM!\innam{NAM\_EOL\_ALM}}
...
\end{center}
\begin{itemize}
    \item LHGT\_QS: flag to activate height dependence of qsat variance (VSIGQSAT)\index{LHGT\_QS!\innam{NAM\_NEBn}}
    \item LSTATNW: flag to switch on the full updated statistical cloud scheme\index{LSTATNW!\innam{NAM\_NEBn}}
    \item XTMINMIX: minimum temperature of mixed phase (K)\index{XTMINMIX!\innam{NAM\_NEBn}}
    \item XTMAXMIX: maximum temperature of mixed phase (K)\index{XTMAXMIX!\innam{NAM\_NEBn}}
\item
\index{LSUBG\_COND!\innam{NAM\_NEBn}}
...
\item
\index{CCONDENS!\innam{NAM\_NEBn}}
...
\item
\index{CLAMBDA3!\innam{NAM\_NEBn}}
...
\item 
CFRAC\_ICE\_SHALLOW\_MF \index{CFRAC\_ICE\_SHALLOW\_MF!\innam{NAM\_NEBn}}: Way to compute ice fraction for MF contribution
\begin{itemize}
\item{'T'} : linear formulation according to temperature
\item{'O'} : Tao et al. (1989) formulation
\item{'N'} : No ice
...
LOUT\_COMPRESS\_LOSSY           & logical(:)           & FALSE        \\
COUT\_COMPRESS\_LOSSY\_ALGO     & character(len=10)(:) & 'GRANULARBR' \\
NOUT\_COMPRESS\_LOSSY\_NSD      & integer(:)           & 3            \\
\hline
...
\item
\index{LOUT\_COMPRESS\_LOSSY!\innam{NAM\_OUTPUT}}
LOUT\_COMPRESS\_LOSSY(m): enable lossy compression of data for each model $m$ (only for files in netCDF format, not for LFI format and only for float numbers)

\item
\index{LOUT\_COMPRESS\_LOSSY\_ALGOL!\innam{NAM\_OUTPUT}}
COUT\_COMPRESS\_LOSSY\_ALGO(m): algorithm used to reduce the number of significants digits or bits. Available algorithms: 'BitGroom', 'GranularBR' and 'BitRound' (case insensitive). Default: 'GranularBR'

\item
\index{LOUT\_COMPRESS\_LOSSY\_NSD!\innam{NAM\_OUTPUT}}
NOUT\_COMPRESS\_LOSSY\_NSD(m): number of significants digits (for 'BitGroom', 'GranularBR') or bits (for 'BitRound') to keep. Allowed values for 'BitGroom', 'GranularBR': 1 to 15 for floats stored with 64 bits and 1 to 7 on 32 bits. And for 'BitRound', 1 to 23 for 32-bit floats and 1 to 52 for 64-bit floats. Default value: 3
...
\item
\index{CELEC!\innam{NAM\_PARAMn}}
CELEC: type of electricity-lightning scheme used to parameterize electrification of hydrometeors
\begin{itemize}
\item
CELEC = 'NONE'  : no electricity-lightning scheme.
\item
CELEC = 'ELE3'  : original scheme CELLS\footnote{see Barthe and Pinty, 2007; Barthe et al. 2007, 2012, 2016)} based on duplication of microphysics ICE3 code. Works only with NAM\_PARAM\_ICEn LRED=F, LSNOW\_T=F.
\item
CELEC = 'ELE4'  : externalization and modernization of ELE3 with possibility to use with LIMA and ICE3 with time-splitting.
 
With LIMA, two configurations are possible in NAM\_PARAM\_LIMA:\\
- LPTSPLIT=T, NMOM\_C=NMOM\_R=NMOM\_I=2, NMOM\_S=NMOM\_G=1, NMOM\_H=0, and LSNOW\_T=F \\
- LPTSPLIT=T, NMOM\_C=NMOM\_R=NMOM\_I=NMOM\_S=NMOM\_G=2,\\ 
NMOM\_H=0, and LSNOW\_T=F. \\
With ICE3, set LRED=T and LSNOW\_T=F in NAM\_PARAM\_ICEn.
\end{itemize}
...
\item NICEOPT: optical properties of ice particles ; 3 = Fu ; 4 = Baran ; 7 = coherent with LIMA with CPRISTINE\_ICE\_LIMA = {YPLA, YCOL, YBUR, YHCO, YHBU}
...
\subsection{Namelist NAM\_PARAM\_ICEn (option for the mixed phase cloud 
parameterization ICE3 and ICE4)}
\index{NAM\_PARAM\_ICEn!namelist description}
%
\begin{longtable} {|p{.35\textwidth}|p{.17\textwidth}|p{.32\textwidth}|}
\hline
Fortran name &  Fortran type & default value \\
\hline 
\endhead
...
CSUBG\_AUCV\_RC &  4 characters  & 'NONE' \\
...
XCRIAUTI\_NAM  & real &  0.2E-4  \\
XT0CRIAUTI\_NAM  & real & (LOG10(XCRIAUTI\_NAM)\\
& & -XBCRIAUTI\_NAM)/0.06   \\
XBCRIAUTI\_NAM  & real & -3.5    \\
XACRIAUTI\_NAM  & real & 0.06    \\
XCRIAUTC\_NAM  & real & 0.5E-3    \\
XRDEPSRED\_NAM  & real & 1.0    \\
XRDEPGRED\_NAM  & real & 1.0    \\
XFRMIN\_NAM  & real(40) &    see \href{https://hirlam.github.io/HarmonieSystemDocumentation/dev/ForecastModel/OCDN2/#Full-list-of-RFRMIN-variables-(included-here-for-completeness,-not-all-OCDN2-related}{the doc} \\
\end{longtable}
...
\begin{itemize}
\item
LWARM \index{LWARM!\innam{NAM\_PARAM\_ICEn}}: When .TRUE. activates the
formation of rain by the warm microphysical processes

\item
CPRISTINE\_ICE \index{CPRISTINE\_ICE!\innam{NAM\_PARAM\_ICEn}}:
...
\item
LSEDIC \index{LSEDIC!\innam{NAM\_PARAM\_ICEn}}:
Cloud droplets are allowed to sediment if set to TRUE
\item
CSEDIM (new in masdev48) \index{CSEDIM!\innam{NAM\_PARAM\_ICEn}}:
...
\item
LCONVHG \index{LCONVHG!\innam{NAM\_PARAM\_ICEn}}: For ICE4, .TRUE. activates the
reconversion of hail to graupel for low values of supercooled cloud water or hail contents.

\item
LDEPOSC \index{LDEPOSC!\innam{NAM\_PARAM\_ICEn}}: TRUE to enable cloud droplet deposition

\item
XVDEPOSC \index{XVDEPOSC!\innam{NAM\_PARAM\_ICEn}}: Droplet deposition velocity

\item 
LRED  \index{LRED!\innam{NAM\_PARAM\_ICEn}}: To use modified ICE3/ICE4 to reduce time step dependency

\item 
LFEEDBACKT  \index{LFEEDBACKT!\innam{NAM\_PARAM\_ICEn}}:  .TRUE. when feedback on temperature is taken into account (active when LRED=T)

\item 
LEVLIMIT  \index{LEVLIMIT!\innam{NAM\_PARAM\_ICEn}}: .TRUE. when water vapour pressure is limited by saturation (active when LRED=T)

\item 
LNULLWETG  \index{LNULLWETG!\innam{NAM\_PARAM\_ICEn}}: .TRUE. when graupel wet growth is activated with null rate (to allow water shedding) (active when LRED=T)

\item 
LWETGPOST  \index{LWETGPOST!\innam{NAM\_PARAM\_ICEn}}: .TRUE. when graupel wet growth is activated with positive temperature (to allow water shedding) (active when LRED=T)
 
\item 
LNULLWETH  \index{LNULLWETH!\innam{NAM\_PARAM\_ICEn}}: Same as LNULLWETG but for hail

\item 
LWETHPOST  \index{LWETHPOST!\innam{NAM\_PARAM\_ICEn}}: Same as LWETGPOST but for hail

\item 
CSNOWRIMING  \index{CSNOWRIMING!\innam{NAM\_PARAM\_ICEn}}:  Parametrization for snow riming (active when LRED=T)
\begin{itemize}
...
\item 
XFRACM90 \index{XFRACM90!\innam{NAM\_PARAM\_ICEn}}: Fraction used for the Murakami 1990 formulation (active when LRED=T)

\item 
NMAXITER\_MICRO  \index{NMAXITER\_MICRO!\innam{NAM\_PARAM\_ICEn}}: Maximum number of iterations for mixing ratio or time splitting (active when LRED=T)

\item 
XMRSTEP  \index{XMRSTEP!\innam{NAM\_PARAM\_ICEn}}: Maximum mixing ratio step for mixing ratio splitting (active when LRED=T)

\item 
XTSTEP\_TS  \index{XTSTEP\_TS!\innam{NAM\_PARAM\_ICEn}}: Approximative time step for time-splitting (0 for no time-splitting) (active when LRED=T)

\item 
LADJ\_BEFORE  \index{LADJ\_BEFORE!\innam{NAM\_PARAM\_ICEn}}: .TRUE. when an adjustment before rain\_ice call is performed (active when LRED=T)

\item 
LADJ\_AFTER  \index{LADJ\_AFTER!\innam{NAM\_PARAM\_ICEn}}: .TRUE. when an adjustment after rain\_ice call is performed (equal to T when LRED=F)

\item \index{LSNOW\_T!\innam{NAM\_PARAM\_ICEn}}
...
\item
LPACK\_INTERP  \index{LPACK\_INTERP!\innam{NAM\_PARAM\_ICEn}}: to save computation time, some mycrophysical processes (especially collections) are tabulated. If this key is .TRUE., the input variables for the interpolations are packed to limit the computation to the necessary points; otherwise, the interpolations are performed everywhere.

\item
LPACK\_MICRO  \index{LPACK\_MICRO!\innam{NAM\_PARAM\_ICEn}}: the microphysics input variables are packed to perform the computation only on points with hydrometeors; otherwise, computations are performed everywhere..

\item 
LCRFLIMIT  \index{LCRFLIMIT!\innam{NAM\_PARAM\_ICEn}}: .TRUE. to limit rain contact freezing to possible heat exchange (active when LRED=T)

\item 
XSPLIT\_MAXCFL \index{XSPLIT\_MAXCFL!\innam{NAM\_PARAM\_ICEn}}: Maximum CFL number allowed for SPLIT scheme (active when LRED=T)

\item 
LSEDIM\_AFTER  \index{LSEDIM\_AFTER!\innam{NAM\_PARAM\_ICEn}}: sedimentation done before (.FALSE.) or after (.TRUE.) microphysics (active when LRED=T)

\item
\index{CSUBG\_AUCV\_RC!\innam{NAM\_PARAM\_ICEn}}
CSUBG\_AUCV\_RC : Type of subgrid $r_c$ - $r_r$ autoconversion scheme.
\begin{itemize}
\item  'NONE'
...
\item
\index{CSUBG\_AUCV\_RI!\innam{NAM\_PARAM\_ICEn}}
...
\item
\index{CSUBG\_MF\_PDF!\innam{NAM\_PARAM\_ICEn}}
...
\item
CSUBG\_RC\_RR\_ACCR \index{CSUBG\_RC\_RR\_ACCR!\innam{NAM\_PARAM\_ICEn}}:
...
\item
CSUBG\_RR\_EVAP \index{CSUBG\_RR\_EVAP!\innam{NAM\_PARAM\_ICEn}}:
...
\item
CSUBG\_PR\_PDF \index{CSUBG\_PR\_PDF!\innam{NAM\_PARAM\_ICEn}}:
...
\end{itemize}
    \item NPROMICRO\index{NPROMICRO!\innam{NAM\_PARAM\_ICEn}}: size of cache-blocking bloc (0 to deactivate)
    \item LCRIAUTI\index{LCRIAUTI!\innam{NAM\_PARAM\_ICEn}}: True to compute XACRIAUTI and XBCRIAUTI (from XCRIAUTI and XT0CRIAUTI); False to compute XT0CRIAUTI (from XCRIAUTI and XBCRIAUTI)
    \item LOCND2\index{LOCND2!\innam{NAM\_PARAM\_ICEn}}:  flag to switch on the OCND2 scheme that separates liquid and ice (full documentation here\footnote{https://hirlam.github.io/HarmonieSystemDocumentation/dev/ForecastModel/OCDN2/})
    \item XCRIAUTI\_NAM\index{XCRIAUTI\_NAM!\innam{NAM\_PARAM\_ICEn}}: minimum value for the ice$\rightarrow$snow autoconversion threshold
    \item XT0CRIAUTI\_NAM\index{XT0CRIAUTI\_NAM!\innam{NAM\_PARAM\_ICEn}}:  threshold temperature for the ice$\rightarrow$snow autoconversion threshold
    \item XBCRIAUTI\_NAM\index{XBCRIAUTI\_NAM!\innam{NAM\_PARAM\_ICEn}}: B parameter for the ice$\rightarrow$snow autoconversion 10**(aT+b) law
    \item XACRIAUTI\_NAM\index{XACRIAUTI\_NAM!\innam{NAM\_PARAM\_ICEn}}: A parameter for the ice$\rightarrow$snow autoconversion 10**(aT+b) law
    \item XCRIAUTC\_NAM\index{XCRIAUTC\_NAM!\innam{NAM\_PARAM\_ICEn}}: threshold for liquid cloud $\rightarrow$ rain autoconversion (kg/m**3)
    \item XRDEPSRED\_NAM\index{XRDEPSRED\_NAM!\innam{NAM\_PARAM\_ICEn}}: tuning factor of sublimation of snow
    \item XRDEPGRED\_NAM\index{XRDEPGRED\_NAM!\innam{NAM\_PARAM\_ICEn}}: tuning factor of sublimation of graupel
    \item XFRMIN\_NAM\index{XFRMIN\_NAM!\innam{NAM\_PARAM\_ICEn}}: parameters to modify melt and growth of graupels 
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item
\index{CINT\_MIXING!\innam{NAM\_PARAM\_LIMA}}
CINT\_MIXING : String to select the proportion of each IFN type in each IFN mode. Possible values :
\begin{itemize}
\item 'DM1' pure small dust particles
\item 'DM2' pure large dust particles
\item 'BC'  pure black carbon
\item 'O'   pure organics
\item 'CAMS', 'CAMS\_JPP', 'CAMS\_AIT', 'CAMS\_ACC', 'MOCAGE',  mix for use of CAMS or MOCAGE aerosols
\item 'DEFAULT' mix as in Phillips et al 2008 or 2013
\end{itemize}

\item
\index{CIFN\_SPECIES!\innam{NAM\_PARAM\_LIMA}}
CIFN\_SPECIES : String to select the IFN modes size distribution parameters. Available options are :
\begin{itemize}
\item 'MOCAGE', 'CAMS\_JPP', 'CAMS\_AIT', 'CAMS\_ACC' for use with MOCAGE/CAMS aerosols
\item 'DEFAULT' to use the same parameters as in Phillips et al. 2008 or 2023
\end{itemize}
\item
...
NIND\_SPECIE : Type of the “coated IFN” mode. 1 for dust, 2 for black carbon or 3 for organics
\item
\index{CPRISTINE\_ICE\_LIMA!\innam{NAM\_PARAM\_LIMA}}
CPRISTINE\_ICE\_LIMA : Select the shape of pristine ice among:
\begin{itemize}
\item{'PLAT'} : plates 
\item{'COLU'} : columns
\item{'BURO'} : bullet rosettes
\item{'YPLA'} : plates from Yang et al. 2013
\item{'YCOL'} : column from Yang et al. 2013
\item{'YBUR'} : solid bullet rosette from Yang et al. 2013
\item{'YDRO'} : droxtal from Yang et al. 2013
\item{'YHCO'} : hollow column from Yang et al. 2013
\item{'YHBU'} : hollow bullet rosette from Yang et al. 2013
\end{itemize}
\item
...
\item
\index{LKESSLERAC!\innam{NAM\_PARAM\_LIMA}}
LKESSLERAC : Set to T to use the Kessler autoconversion of cloud droplets into rain drops, based on the droplets mixing ratio. Useful if NMOM\_C=1 to have results closer to ICE3 simulations.
...
\item
\index{LTHETAS\_MF!\innam{NAM\_PARAM\_MFSHALLn}}
LTHETAS\_MF : True to compute ThetaS from ThetaL
\item
...
XGZ : parameter for the reduction the surface closure of the Mass-Flux thermal plume if LGZ = TRUE.
    \item 
    LVERLIMUP: flag to allow a smooth vertical decrease of the mass-flux as soon as the updraft reaches a specific altitude, instead of a sharp limit of 0.\index{LVERLIMUP!\innam{NAM\_PARAM\_MFSHALLn}}
...
\index{LDIAG\_SURFRAD!\innam{NAM\_PROFILERn}}
...
\begin{longtable} {|p{.25\textwidth}|p{.20\textwidth}|p{.25\textwidth}|}
\hline
Fortran name &  Fortran type & default value \\
\hline 
\endhead
...
LSMOOTH\_PRANDTL        & logical &  TRUE   \\
NTURBSPLIT        & integer &  1   \\
LTURB\_PRECIP        & logical          & FALSE        \\
\end{longtable}
...
\item
\index{XTKEMIN!\innam{NAM\_TURBn}}
XTKEMIN: minimum value for the TKE ($m^{2}.s^{-2}$).

\item
\index{XCED!\innam{NAM\_TURBn}}
XCED: Constant for TKE dissipation
...
\item LCLOUDMODIFLM \index{LCLOUDMODIFLM!\innam{NAM\_TURBn}}:
model number where the modification of the mixing length in the clouds is
computed.
\item CTURBLEN\_CLOUD \index{CTURBLEN\_CLOUD!\innam{NAM\_TURBn}}:
type of turbulent mixing length in the clouds
 ('BL89','DELT','DEAR': see CTURBLEN for meanings),
\item XCOEF\_AMPL\_SAT \index{XCOEF\_AMPL\_SAT!\innam{NAM\_TURBn}}:
saturation of the amplification coefficient,
\item XCEI\_MIN \index{XCEI\_MIN!\innam{NAM\_TURBn}}:
minimum threshold for the instability index (in kg/kg/m/s,
 beginning of the amplication),
\item XCEI\_MAX \index{XCEI\_MAX!\innam{NAM\_TURBn}}:
maximum threshold for the instability index (in kg/kg/m/s,
 beginning of the saturation of the amplification).
\item XPHI\_LIM\index{XPHI\_LIM!\innam{NAM\_TURBn}} is the threshold value for $\phi _{3}$ and $\psi _{3}$
\item XSBL\_O\_BL\index{XSBL\_O\_BL!\innam{NAM\_TURBn}} is SBL height / BL height ratio
\item XFTOP\_O\_FSURF\index{XFTOP\_O\_FSURF!\innam{NAM\_TURBn}} is the fraction of surface (heat or momentum) flux used to define top of BL
   \item XCTP: Constant for temperature and vapor pressure-correlations (if not defined, the value depends on LSTATNW)\index{XCTP!\innam{NAM\_TURBn}}
    \item XMINSIGS: minimum value of the variance of the deficit to the saturation out of the turbulence scheme $kg^2.kg^{-2}$)\index{XMINSIGS!\innam{NAM\_TURBn}}
    \item LHARAT: flag to activate the RACMO turbulence scheme\index{LHARAT!\innam{NAM\_TURBn}}
    \item LPROJQITURB: flag to project the $r_t$ tendency on $r_c$ and $r_i$\index{LPROJQITURB!\innam{NAM\_TURBn}}
    \item LSMOOTH\_PRANDTL: flag to smooth the Prandtl functions\index{LSMOOTH\_PRANDTL!\innam{NAM\_TURBn}}
    \item NTURBSPLIT: number of time-splitting for the computation of horizontal turbulent fluxes\index{NTURBSPLIT!\innam{NAM\_TURBn}}
    \item LTURB\_PRECIP: flag to activate the turbulent mixing of mixing ratios of snow, graupel, hail and liquid droplets $r_s$, $r_g$, $r_h$, and $r_r$\index{LTURB\_PRECIP!\innam{NAM\_TURBn}}
\end{itemize}
