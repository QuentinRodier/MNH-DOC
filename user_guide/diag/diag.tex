...
\end{center}
\begin{itemize}
\item LISOAL\index{!\innam{NAM\_DIAG}}: flag to interpolate on altitude levels the following variables: potential vorticity, wind, cloud (liquid water and ice) and precipitation (rain, snow and graupel) mixing ratio, dust extinction (if available)
\item XISOAL\index{!\innam{NAM\_DIAG}}: altitude of the isobaric levels
\item LISOPR\index{!\innam{NAM\_DIAG}}: flag to interpolate on altitude levels the following variables: potential temperature, wind, water vapour mixing ratio, geopotential (in meters)
