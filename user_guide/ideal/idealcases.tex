...
\item CCLOUD: microphysics scheme (only "LIMA" possible) to use with aerosols coupling
\item NMOD\_CCN : numer of CCN modes
\item NMOD\_IFN : numer of IFN modes
\item LDSTCAMS \index{LDSTCAMS!\innam{NAM\_AERO\_PRE}} : flat to activate initialization of dust aerosols from CAMS file.
\item LSLTCAMS \index{LSLTCAMS!\innam{NAM\_AERO\_PRE}} : flat to activate initialization of sea-salt aerosols from CAMS file.
\end{itemize}
